        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                tasks.forEach(task => {
                  ...
                  <tr taskId="${task.id}">
                  <td>${task.EMPRESA}</td>
                  <td><a href="#" class="task-item">${task.DIRECCION-EMPRESA}</a></td>
                  <td>${task.DESCRIPCION}</td>
                  <td>${task.NOMBRE-CLIENTE}</td>
                  <td>${task.DIRECCION-CLIENTE}</td>
                  <td>${task.RUC-CLIENTE}</td>
                  <td>${task.CANTIDAD-PRODUCTO}</td>
                  <td>${task.DESCRIPCION-PRODUCTO}</td>
                  <td>${task.PRECIO-UNITARIO}</td>
                  <td>${task.IMPORTE}</td>
                  <td>${task.IGV}</td>
                  <td>${task.TOTAL}</td>
                  <td>
